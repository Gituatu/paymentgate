...
function solve(){
    ...
    fetch('/orders' , data_send).then(info => info.json()).then(data =>{
        var options = {
            "key": "rzp_test_1DL5gMUADOR83a", // Enter the Key ID generated from the Dashboard
            ...
            "handler": function (response){
                ...
                Email.send({
                    Host: "smtp.gmail.com",
                    Username: "demopayacc1@gmail.com",
                    Password: "#demopay1",
                    To: "demopayacc2@gmail.com",
                    From: "demopayacc1@gmail.com",
